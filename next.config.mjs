        ...
        headers: [
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.privy.io https://*.walletconnect.com http://localhost:8000 https://*.workers.dev https://*.cdn08.workers.dev https://ipfs.io https://gateway.pinata.cloud https://cloudflare-ipfs.com https://*.thcloud.dev",
